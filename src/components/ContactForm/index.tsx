...
function HomeInside() {
  ...
  return (
    <div className="container">
      <main className="mt-5">
        <form id="contactForm" onSubmit={handleSubmit(onSubmit)} className="bg-pt-gray2 p-4">
          <div className="wrapperName mb-5">
            ...
            >
              {t("name")}
              {<span className={`ml-1 ${errors.name ? 'text-red-500' : 'text-black'}`}>*</span>}
            </label>
            <input
              type="text"
          ...
          <div className="wrapper flex flex-col md:flex-row md:gap-3">
            <div className="flex-grow wrapperEmail mb-5">
              ...
              >
                {t("email")}
                {<span className={`ml-1 ${errors.email ? 'text-red-500' : 'text-black'}`}>*</span>}
              </label>
              <input
                type="email"
          ...
          <div className="wrapperMessage mb-5">
            ...
            >
              {t("writeMessage")}
              {<span className={`ml-1 ${errors.message ? 'text-red-500' : 'text-black'}`}>*</span>}
            </label>
            <textarea
              rows={4}
            ...
            />
            {errors.message && <span className="text-red-500">{t("required")}</span>}
          </div>
